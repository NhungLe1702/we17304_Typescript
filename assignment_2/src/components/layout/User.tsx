    ...
    <>
      ...
      <header className="bg-[#D70018]">
        <div className="container mx-auto flex items-center gap-[100px]">
          ...
          <input className="h-[34px] grow rounded-lg" type="text" placeholder="search" />
        </div>
      </header>
            ...
            <div className="mt-[100px]">
                <div className="footer_top flex justify-between">
                    <div className="footer_top_item">
                        ...
                        <ul className="text-[13px] leading-7 ">
                            <li><a>Tìm của hàng gần nhất </a></li>    
                            <li><a>Mua hàng từ xa</a></li>                        
                            <li><a>Gặp trực tiếp cửa hàng gần nhất(Zalo hoặc gọi điện)</a></li>
                        </ul> 

                        <p className="text-[#38383D] text-[16px]">Phương thức thanh toán</p>
                        <div>

                            <img className="w-[200px]" src="/Screen Shot 2023-04-03 at 10.21.20.png"/>
                    ...
                    <div className="footer_top_item">
                        ...
                        <p className="text-[#38383D] text-[16px]">Đối tác dịch vụ bảo hành</p> 
                        <ul className="text-[13px] leading-7 ">
                        ...
                        <p className="text-[#38383D] text-[16px]">Đối tác dịch vụ bảo hành</p> 
                        <div>
                            <img className="w-[200px]" src="/cropped-New-logo-DTV-ASP-01.png" />
                        </div>
                    </div>
                ...
                <div className="footer_bottom">
                    <div className="footer_info py-5 text-[13px] leading-7 ">
                        <p>Trụ sở chính: Toà nhà Viettel, số 285, đường Cách Mạng Tháng 8, Phường 12, quận 10, thành phố Hồ Chí Minh</p>
                        ...
                        <p>Giấy chứng nhận đăng kí kinh doanh số 0309532909 do Sở Kế hoạch và Đầu tư cấp lần đầu ngày 06/01/2010 và sửa dổi lần thứ 23 ngày 14/02/2022</p>
